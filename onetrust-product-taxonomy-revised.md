...
This article is a product and routing reference. It is not a licence, entitlement, contract, or feature-availability source.
...
Product-specific documentation is required to support claims about that product’s capabilities or behaviour. This is an evidence boundary, not a rigid response workflow.
...
Current sources use both Data & AI Governance and Data Use Governance. Until a single canonical customer-facing name is confirmed:
...
The following product map is intended to support routing and retrieval. It is not a complete feature catalogue.
