...
- **Role:** Routing and evidence reference
- **Authority:** Canonical for product, solution, capability, alias, package, and product-specific evidence boundaries
- **Not authoritative for:** Case submission workflow, response tone, or Maven action execution
- **Load mode:** Retrieval when product identification or product capability evidence is relevant
- **Owner:** Customer Support Operations / Product Knowledge Management



Audience: Maven Support Agent
Applies to: Product identification, routing, knowledge retrieval, and customer guidance
...
- Use Capability Disambiguation to determine whether the customer is asking about OneTrust functionality or a Maven action.
- Use this document to map OneTrust product language and establish the product-specific evidence boundary.
- Use Support Case Taxonomy for valid case-field values.
- Use Escalation Protocol for case drafting, approval, and submission.
...
- use consistent product names in customer responses
- prevent unsupported capability assumptions between products
This article is a product and routing reference.
It is not a licence, entitlement, contract, or feature-availability source.
...
Packages should not be treated as a strict child level beneath capabilities.
...
- Use approved customer-facing terminology in the response where it differs from an internal routing value.
...
The product explicitly named or clearly identified in the customer prompt is the response anchor.
Product-specific documentation is required to support claims about that product’s capabilities or behaviour.
...
- If direct evidence is unavailable, provide the most useful safe response: qualify the limitation, ask a focused question, or route to support.
- Do not present an inference as confirmed functionality for the named product.
- For comparisons, use product-specific evidence for each product rather than generalising from one product to another.
...
- do not describe either term as definitively legacy
- use the terminology present in the relevant approved customer-facing source when responding

## Products and capabilities

The following product map is intended to support routing and retrieval.
It is not a complete feature catalogue.
...
| Use CMP for cookie-banner and consent-management questions.         | &nbsp;                                                                                                              |
| Use UCPM for preference-centre and preference-management questions. | &nbsp;                                                                                                              |
| Clarify when “consent” is used broadly.                             | &nbsp;                                                                                                              |
...
| Privacy Operations                                                                                                                   | Customer-facing umbrella term.                                                                                                                   |
| Narrow to the specific product when the customer’s intent supports it.                                                               | &nbsp;                                                                                                                                           |
| &nbsp;                                                                                                                               | &nbsp;                                                                                                                                           |
...
| Use Third-Party Risk Management for the broader vendor lifecycle.               | &nbsp;                                                                                                                          |
| Use Third-Party Due Diligence for screening and due diligence.                  | &nbsp;                                                                                                                          |
| Use Third-Party Risk Exchange for external risk intelligence and vendor scores. | &nbsp;                                                                                                                          |
...
Customers may refer to packages instead of products or capabilities.
Treat package mentions as routing and retrieval signals only.
...
| &nbsp;                                 | &nbsp;                                    | &nbsp;                                                                                                 |
| Data mapping                           | Data Mapping Automation                   | Use the specific product when the customer means mapping, inventory, lineage, or cross-border mapping. |
| &nbsp;                                 | &nbsp;                                    | &nbsp;                                                                                                 |
...
Use the following sequence as a guide, adapting it to the customer’s question:
...
For customer-facing product answers, prefer published customer-visible product documentation.
Use broader solution or platform content for context, terminology, or navigation, but not as proof that a named product supports a capability.
When responding:
...
- do not overstate feature availability or package inclusion
...
- a new product, capability, or major alias is introduced
